...
import com.libgdx.cookbook.box2d.BodyEditorLoader;
import com.libgdx.cookbook.help.BaseScreen;

public class Box2DComplexShapesSample extends BaseScreen {
    ...
    private void createChainShape() {
        ...
        chainShape.createLoop(new Vector2[] { new Vector2(.0f, .0f),
                new Vector2(SCENE_WIDTH, .0f), new Vector2(SCENE_WIDTH, 1.5f),
                new Vector2(6f, 1.5f), new Vector2(3, 5.0f),
                new Vector2(1.5f, 1.5f), new Vector2(0, 1.5f), });
    ...
    private void createGlass() {
        ...
        BodyEditorLoader loader = new BodyEditorLoader(
                Gdx.files.internal("data/box2D/glass.json"));
        ...
        // Magic happens here!! Glass fixture is generated automatically by the
        // loader.
