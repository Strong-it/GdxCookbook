package com.libgdx.cookbook.animation;
...
public class SpriteAnimationLoader extends AsynchronousAssetLoader<SpriteAnimationData, SpriteAnimationLoader.AnimationParameter> {
    ...
    /**
     * Asynchronously loads the animation data animations
     */
    @Override
     ...
     */
    @Override
    public SpriteAnimationData loadSync(AssetManager manager, String fileName,
            FileHandle file, AnimationParameter parameter) {
