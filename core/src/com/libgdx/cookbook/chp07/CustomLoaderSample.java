...
import com.libgdx.cookbook.animation.SpriteAnimationData;
import com.libgdx.cookbook.animation.SpriteAnimationLoader;
import com.libgdx.cookbook.help.BaseScreen;

/**
 * 自定义AssetManager
 * 主要在于自己定义SpriteAnimationData  这是Asset的数据类型
 * SpriteAnimationLoader  这是数据类型加载器
 *
 */
public class CustomLoaderSample extends BaseScreen {

    private static final String TAG = CustomLoaderSample.class.getSimpleName();
